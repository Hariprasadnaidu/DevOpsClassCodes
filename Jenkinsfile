...
[$class: 'hudson.model.StringParameterDefinition', name: 'K8S_CLUSTER_URL',defaultValue: "https://zld03838.vci.att.com"],
[$class: 'hudson.model.StringParameterDefinition', name: 'SPRING_PROFILES_ACTIVE',defaultValue: "dev"],
...
[$class: 'hudson.model.PasswordParameterDefinition', name: 'K8S_PASSWORD',defaultValue: "password"],
...
[$class: 'hudson.model.StringParameterDefinition', name: 'K8S_SERVICE_ACCOUNT',defaultValue: "lpp-ajsc-dev"]   
]]]) 
...
node("docker") {
	...
	IMAGE_NAME=pom.properties['docker.registry']+"/"+pom.groupId+"/"+pom.artifactId+":latest"
